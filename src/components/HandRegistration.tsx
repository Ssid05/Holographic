          ...
          <div className="registration-welcome">
            ...
            <div className="registration-steps-preview">
              <div className="step-preview">
                ...
                <span className="step-text">Left Palm</span>
              </div>
              <div className="step-divider"></div>
              <div className="step-preview">
                <span className="step-num">2</span>
                <span className="step-text">Left Back</span>
              </div>
              <div className="step-divider"></div>
              <div className="step-preview">
                <span className="step-num">3</span>
                <span className="step-text">Right Palm</span>
              </div>
              <div className="step-divider"></div>
              <div className="step-preview">
                <span className="step-num">4</span>
                <span className="step-text">Right Back</span>
              </div>
            </div>
            ...
            <button className="start-button" onClick={startRegistration}>
              ...
              <span className="btn-text">Begin Registration</span>
            </button>
